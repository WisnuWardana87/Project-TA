...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Feb 2021 pada 04.21
...
--
-- Struktur dari tabel `tb_jenis_juara`
--
...
--
-- Dumping data untuk tabel `tb_jenis_juara`
--
...
--
-- Struktur dari tabel `tb_jenis_prestasi`
--
...
--
-- Dumping data untuk tabel `tb_jenis_prestasi`
--
...
(16, 4, 2, 1, '2021-01-12', '2021-01-15', 'bbbb', 'adas', '122222', 'Sudarma Puja', 'Fakultas Matematika dan Ilmu Pengetahuan Alam (FMIPA)', '11111', '', 2, '2020'),
...
--
-- Indeks untuk tabel `tb_jenis_juara`
--
ALTER TABLE `tb_jenis_juara`
  ADD PRIMARY KEY (`id_jenis_juara`);

--
-- Indeks untuk tabel `tb_jenis_prestasi`
--
...
--
-- AUTO_INCREMENT untuk tabel `tb_jenis_juara`
--
ALTER TABLE `tb_jenis_juara`
  MODIFY `id_jenis_juara` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT untuk tabel `tb_jenis_prestasi`
--
ALTER TABLE `tb_jenis_prestasi`
